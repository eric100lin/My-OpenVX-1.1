...
vx_cl_kernel_description_t add_kernel = {
	{
		VX_KERNEL_ADD,
    ...
    FILE_JOINER"vx_add.cl",
    "vx_add_u8_truncate",	/*TODO: should support saturate*/
    INIT_PROGRAMS,
    INIT_KERNELS,
    INIT_NUMKERNELS,
    INIT_RETURNS,
...
vx_cl_kernel_description_t subtract_kernel = {
	{
		VX_KERNEL_SUBTRACT,
